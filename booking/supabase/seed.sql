...
update public.staff set bio = coalesce(bio, '副院長・鍼灸師。プロ野球選手の自主トレやJOC全国中学バレー大阪選抜、BFAアジア野球選手権 タイ代表などに帯同してきた現場派トレーナー。KYT・DNS研修を修了し、NABOSO認定ニューロセンサリースペシャリスト（Dr. Emily認定）。鍼灸と豊富なトレーナー経験を活かし、痛みや不調の根本にアプローチします。') where name = '澁谷';
