...
-- 患者向け紹介文（HP実データを予約向けに最適化。管理画面のスタッフ管理から編集できます）
update public.staff set bio = coalesce(bio, '院長・柔道整復師。大阪薫英女学院高校・大阪人間科学大学の女子バスケットボール部などでトレーナーを務め、格闘技（RISE）選手のサポートも担当。DNS認定エクササイズトレーナー、NABOSO認定ニューロセンサリースペシャリスト（Dr. Emily認定）として、身体の動きと神経の視点から根本改善を目指します。スポーツ外傷から日常の不調まで幅広く対応し、川西整体院も担当します。') where name = '阿部';
update public.staff set bio = coalesce(bio, '副院長・鍼灸師。プロ野球選手の自主トレやJOC全国中学バレー大阪選抜、BFAアジア野球選手権 日本代表などに帯同してきた現場派トレーナー。KYT・DNS研修を修了し、NABOSO認定ニューロセンサリースペシャリスト（Dr. Emily認定）。鍼灸と豊富なトレーナー経験を活かし、痛みや不調の根本にアプローチします。') where name = '澁谷';
update public.staff set bio = coalesce(bio, '柔道整復師。AVANTI茨木でトレーナー活動を行い、KYT（Ken Yamamoto Technic）院内研修・DNSパート1を受講。専門学生時代に全国模試1位を3回獲得した実力派で、長崎県出身。小1から続けるサッカーで培った身体の知識も活かし、お一人おひとりに丁寧に向き合います。') where name = '萩原';
update public.staff set bio = coalesce(bio, '柔道整復師。阿部接骨院 体幹教室の初期メンバー（当時小6）で、体幹のスペシャリスト。AVANTI茨木でのトレーナー活動、KYT院内研修・DNSパート1受講。自身の経験を活かした体幹指導と施術で、信頼される施術者を目指して日々研鑽しています。体幹教室も担当します。') where name = '林';
