...
export async function loadSettings(sb: SupabaseClient): Promise<Settings> {
  ...
  const defaults: Settings = {
    ...
    questionnaire_admin_url: null,
    questionnaire_text: null,
    class_application_url: null,
    class_application_text: null,
  ...
  return {
    ...
    cancel_text: data.cancel_text ?? null,
    questionnaire_url: data.questionnaire_url ?? null,
    questionnaire_admin_url: data.questionnaire_admin_url ?? null,
    questionnaire_text: data.questionnaire_text ?? null,
    class_application_url: data.class_application_url ?? null,
    class_application_text: data.class_application_text ?? null,
    ...
    personal_done_text: data.personal_done_text ?? null,
    notice_ibaraki: data.notice_ibaraki ?? null,
    notice_kawanishi: data.notice_kawanishi ?? null,
  };
}
